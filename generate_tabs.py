...
def create_block(tab_id, title, items, image_url, image_on_left=False, two_col=False, is_active=False):
    ...
    return f"""
      <div class="menu-row tab-content{display_class}" id="tab-{tab_id}">
        {inner_html}
      </div>"""
...
soup_block = create_block("soup", "SOUP", soup_items, "https://supremehospitals.in/wp-content/uploads/2026/05/soups-scaled.jpg", image_on_left=False, is_active=True)
...
starter_block = create_block("starter", "STARTER (ARABIAN)", starter_items, "https://supremehospitals.in/wp-content/uploads/2026/05/grill-scaled.jpg", image_on_left=True)
...
rice_block = create_block("rice", "RICE & BIRYANI", rice_items, "https://supremehospitals.in/wp-content/uploads/2026/05/briyani-scaled.jpg", image_on_left=False, two_col=True)
...
chinese_block = create_block("chinese", "CHINESE RICE & NOODLES", chinese_items, "https://supremehospitals.in/wp-content/uploads/2026/05/fired-rice-scaled.jpg", image_on_left=True, two_col=True)
...
bread_block = create_block("bread", "BREAD", bread_items, "https://supremehospitals.in/wp-content/uploads/2026/05/Naan-scaled.jpg", image_on_left=False)
...
gravy_block = create_block("gravy", "INDIAN GRAVY (NON-VEG)", gravy_items, "https://supremehospitals.in/wp-content/uploads/2026/05/chicken-gravy-scaled.jpg", image_on_left=True, two_col=True)
...
burger_block = create_block("burger", "BURGER & SANDWICH", burger_items, "https://supremehospitals.in/wp-content/uploads/2026/05/07-scaled.jpg", image_on_left=False, two_col=True)
...
icecream_block = create_block("icecream", "ICE-CREAM", icecream_items, "https://supremehospitals.in/wp-content/uploads/2026/05/ice-cream-scaled.jpg", image_on_left=True, two_col=True)
...
new_menu_html = f"""
    <section id="menu" class="gem-menu-new" style="background-color: var(--bg-dark);">
      ...
      <div class="menu-tabs-container" data-aos="fade-up">
        <button class="menu-tab active" data-target="soup">SOUP</button>
        <button class="menu-tab" data-target="starter">STARTER</button>
        <button class="menu-tab" data-target="rice">BIRYANI</button>
        <button class="menu-tab" data-target="chinese">CHINESE</button>
        <button class="menu-tab" data-target="bread">BREAD</button>
        <button class="menu-tab" data-target="gravy">INDIAN GRAVY</button>
        <button class="menu-tab" data-target="burger">BURGER</button>
        <button class="menu-tab" data-target="icecream">ICE CREAM</button>
      </div>
...
print("Tabbed Menu generated and injected into gem.html successfully.")
